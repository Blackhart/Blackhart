 ...
 */
static void	__BkMeshSampling_ComputeBarycentricSteps(real* barycentric_steps, real const* scale_factors, real const total_scale_factors, size_t const number_of_geoms, size_t const total_of_points);
...
void	__BkMeshSampling_ComputeBarycentricSteps(real* barycentric_steps, real const* scale_factors, real const total_scale_factors, size_t const number_of_geoms, size_t const total_of_points)
{
	...
	{
		size_t const number_of_points_per_geoms = (size_t)(scale_factors[i] / total_scale_factors) * total_of_points;
		size_t const kernel_size_per_geoms = (size_t)sqrt((double)number_of_points_per_geoms * 3);
