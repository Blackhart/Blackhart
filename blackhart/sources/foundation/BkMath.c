...
real BkMath_RadFromDeg(real const deg) { return deg * BK_DEG_TO_RAD; }

real BkMath_DegFromRad(real const rad) { return rad * BK_RAD_TO_DEG; }
...
struct BkPoint3 BkMath_TriangularBarycentricCoordinate(real const u,
                                                       real const v) {
