...
struct BkVector3 BkVector3_FromXYZ(real const x, real const y, real const z) {
  return (struct BkVector3){.x = x, .y = y, .z = z};
}

struct BkVector3 BkVector3_Lerp(struct BkVector3 const* from,
                                struct BkVector3 const* to, real const t) {
...
struct BkVector3 BkVector3_Add_BkVector3(struct BkVector3 const* a,
...
struct BkVector3 BkVector3_Sub_BkVector3(struct BkVector3 const* a,
                                         struct BkVector3 const* b) {
  BK_ASSERT(BK_ISNULL(a));
  BK_ASSERT(BK_ISNULL(b));
...
struct BkVector3 BkVector3_Max(struct BkVector3 const* a,
                               struct BkVector3 const* b) {
  BK_ASSERT(BK_ISNULL(a));
  BK_ASSERT(BK_ISNULL(b));
...
struct BkVector3 BkVector3_Min(struct BkVector3 const* a,
                               struct BkVector3 const* b) {
  BK_ASSERT(BK_ISNULL(a));
  BK_ASSERT(BK_ISNULL(b));
...
void BkVector3_Assign(struct BkVector3* __restrict obj,
...
void BkVector3_Set(struct BkVector3* obj, real const x, real const y,
                   real const z) {
  BK_ASSERT(BK_ISNULL(obj));
...
struct BkVector3 BkVector3_Cross(struct BkVector3 const* a,
                                 struct BkVector3 const* b) {
  BK_ASSERT(BK_ISNULL(a));
  BK_ASSERT(BK_ISNULL(b));
