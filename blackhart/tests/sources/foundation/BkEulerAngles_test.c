...
void BkEulerAngles_FromXYZ_test(void) {
  struct BkEulerAngles ea =
      BkEulerAngles_FromXYZ(BK_REAL(45), BK_REAL(90), BK_REAL(180));
...
void BkEulerAngles_FromBkQuaternion_test(void) {
  struct BkEulerAngles ea =
      BkEulerAngles_FromXYZ(BK_REAL(0), BK_REAL(45), BK_REAL(0));
...
void BkEulerAngles_FromBkMatrix4x4_test(void) {
  struct BkEulerAngles ea =
      BkEulerAngles_FromXYZ(BK_REAL(0), BK_REAL(0), BK_REAL(45));
