 ...
 */
extern struct BkOpenGLShader*		_BkOpenGL_CreateShader(char const* path, enum BkShaderType const shader_type);

/*! \brief Destroy an OpenGL shader.
 *
 * \param shader The OpenGL shader to destroy.
 */
extern void				_BkOpenGL_ReleaseShader(struct BkOpenGLShader** shader);
 ...
 */
extern struct BkOpenGLShaderProgram*	_BkOpenGL_CreateShaderProgram(struct BkOpenGLShader* vertex_shader, struct BkOpenGLShader* pixel_shader);

/*! \brief Destroy an OpenGL shader program.
 *
 * \param shader_program The OpenGL shader program to destroy.
 */
extern void				_BkOpenGL_ReleaseShaderProgram(struct BkOpenGLShaderProgram** shader_program);
