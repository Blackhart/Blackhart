 ...
 *
 * This file provides structures and functions for managing OpenGL shaders and shader programs.
 ...
 *
 * Deletes the OpenGL shader object and frees the memory allocated for the shader structure.
 * The shader pointer is set to NULL after release.
 *
 * @param shader Pointer to a pointer to the shader to release. The pointer will be set to NULL.
 */
 ...
 *
 * @return Pointer to the newly created shader program, or NULL if creation fails.
 */
 ...
 *
 * Attaches the specified shader to the shader program. The shader will be included
 * in the program when it is compiled. Multiple shaders of different types can be
 ...
 * If compilation or linking fails, error information should be retrieved from OpenGL.
 *
