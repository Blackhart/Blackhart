 ...
 *
 * This file provides structures and functions for managing OpenGL buffer
 * objects (vertex buffers, index buffers, etc.). Note: Functions in this file
 * are marked as INTERNAL and should not be used directly by external code.
 */
 ...
 * the GPU, and returns the buffer structure. The buffer can be used for vertex
 * data, index data, or other buffer purposes.
 *
 * @param size The size in bytes of the data to store in the buffer.
 * @param data Pointer to the data to upload to the buffer. Can be NULL to
 * create an empty buffer.
 * @return Pointer to the newly created buffer object, or NULL if creation
 * fails.
 */
 ...
 * buffer structure. The buffer pointer is set to NULL after release.
 *
 * @param buffer Pointer to a pointer to the buffer to release. The pointer will
 * be set to NULL.
 */
