 ...
 *
 * This file provides functions for file operations including checking file existence,
 * opening/closing files, reading/writing file contents, and path manipulation.
 */
 ...
 *
 * @param flux Pointer to a pointer to BkFlux. Will be set to the opened file stream.
 * @param filename Path to the file to open.
 * @param mode File access mode (e.g., "r" for read, "w" for write, "a" for append).
 */
 ...
 *
 * @param flux Pointer to a pointer to BkFlux. The pointer will be set to NULL after closing.
 */
 ...
 *
 * Reads all data from the file at the specified path into a dynamically allocated buffer.
 * The buffer and its size are set by this function. The caller is responsible for
 * freeing the buffer when done.
 *
 * @param path Path to the file to read.
 * @param buffer Pointer to a char pointer. Will be set to point to the allocated buffer
 *               containing the file contents [OUT].
 * @param buffer_size Pointer to a size_t. Will be set to the size of the allocated buffer [OUT].
 */
 ...
 *
 * Reads all remaining data from the opened file stream into a dynamically allocated buffer.
 * The buffer and its size are set by this function. The caller is responsible for
 * freeing the buffer when done.
 *
 * @param flux Pointer to an opened file stream. The flux must be open before calling this function.
 * @param buffer Pointer to a char pointer. Will be set to point to the allocated buffer
 *               containing the file contents [OUT].
 * @param buffer_size Pointer to a size_t. Will be set to the size of the allocated buffer [OUT].
 */
