 ...
 * @brief Defines the BkEulerAngles structure and functions for Euler angle rotations.
 *
 * This file provides the definition of the BkEulerAngles struct which represents rotations
 * as three separate angles around the x, y, and z axes, and functions to construct them
 * from various rotation representations.
 */
 ...
 *
 * Euler angles represent a rotation as three separate angles around the x, y, and z axes.
...
/**
 * @brief Constructs a BkEulerAngles object with specified x, y, and z components.
 *
 * Creates an Euler angles representation from individual rotation angles around each axis.
 *
