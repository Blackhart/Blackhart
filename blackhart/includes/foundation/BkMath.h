 ...
 *
 * This file provides mathematical utility functions including angle conversions,
 * trigonometric conversions, barycentric coordinates, and value clamping operations.
 */
 ...
 *
 * Multiplies the degree value by the conversion factor to obtain the equivalent in radians.
 *
 ...
 *
 * Multiplies the radian value by the conversion factor to obtain the equivalent in degrees.
 *
 ...
 * @param sin The sine value.
 * @param cos The cosine value.
 * @return The tangent value (sin/cos), or 0 if cos is zero to avoid division by zero.
 */
 ...
 *
 * Barycentric coordinates represent a point within a triangle as a weighted combination
 * of the triangle's vertices. The sum of u and v should not exceed 1.0, with the third
 * coordinate being w = 1 - (u + v).
 *
