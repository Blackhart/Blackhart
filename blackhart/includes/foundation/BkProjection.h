 ...
 *
 * This file provides functions for creating various types of projection matrices,
 * such as perspective projections for 3D rendering.
 */
 ...
 *
 * The perspective projection matrix transforms 3D coordinates in view space into
 * normalized device coordinates (NDC) with perspective correction. Objects closer
 * to the camera appear larger, creating a realistic 3D perspective effect.
 *
 ...
 *                     This should match the window's aspect ratio to avoid distortion.
