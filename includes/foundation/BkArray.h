...
*/
extern BK_API void	BkArray_Initialize(struct BkArray* vector, uint8 const data_size);
...
*/
extern BK_API void	BkArray_Reserve(struct BkArray* vector, size_t const capacity);
...
*/
extern BK_API void	BkArray_Erase(struct BkArray* vector, size_t const index);
...
* \param data The data to insert
*/
extern BK_API void	BkArray_Insert_t(struct BkArray* vector, size_t const index, char const* data);
...
* \param data The data to insert
*/
extern BK_API void	BkArray_Resize_t(struct BkArray* vector, size_t const size, char const* data);
