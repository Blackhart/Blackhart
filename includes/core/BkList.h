 ...
 */
extern BK_API struct BkList*	BkList_Front(struct BkList const* list);
...
*/
extern BK_API struct BkList*	BkList_Back(struct BkList const* list);
...
*/
extern BK_API uint32	BkList_Size(struct BkList const* list);
...
*/
extern BK_API struct BkList*	BkList_Insert(struct BkList* list, void const* data, uint32 const index);
...
* \return The start of the BkList
*/
extern BK_API struct BkList*	BkList_Erase(struct BkList* list, void const* data);
...
* \return The start of the BkList
*/
extern BK_API struct BkList*	BkList_PushFront(struct BkList* list, void const* data);
...
* \return The start of the BkList
*/
extern BK_API struct BkList*	BkList_PushBack(struct BkList* list, void const* data);
