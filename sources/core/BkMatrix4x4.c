...
struct BkMatrix4x4	Identity_mat4()
{
...
struct BkMatrix4x4	Multiply_mat4_mat4(struct BkMatrix4x4 const* a, struct BkMatrix4x4 const* b)
{
	struct BkMatrix4x4 res;
...
struct BkMatrix4x4	Multiply_mat4_real(struct BkMatrix4x4 const* a, real const b)
{
	struct BkMatrix4x4 res;
...
void	Assign_mat4(struct BkMatrix4x4* dst, struct BkMatrix4x4 const* src)
{
	dst->m11 = src->m11; dst->m12 = src->m12; dst->m13 = src->m13; dst->m14 = src->m14;
	dst->m21 = src->m21; dst->m22 = src->m22; dst->m23 = src->m23; dst->m24 = src->m24;
	dst->m31 = src->m31; dst->m32 = src->m32; dst->m33 = src->m33; dst->m34 = src->m34;
...
struct BkMatrix4x4	Transpose_mat4(struct BkMatrix4x4 const* a)
{
	struct BkMatrix4x4 res;
